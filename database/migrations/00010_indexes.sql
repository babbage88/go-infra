...
DROP INDEX IF NOT EXISTS dns_records_idx_zone;
DROP INDEX IF NOT EXISTS dns_records_idx_name;
DROP INDEX IF NOT EXISTS dns_records_idx_content;
DROP INDEX IF NOT EXISTS dns_records_idx_type;
DROP INDEX IF NOT EXISTS host_servers_idx_hostname;
DROP INDEX IF NOT EXISTS host_servers_idx_username;
DROP INDEX IF NOT EXISTS user_hosted_db_idx_userid;
-- +goose StatementEnd
